...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"'IT Support' calls you asking for your portal password to fix a virus on your machine. Do you give it?","opts":[{"text":"Yes, but I will change it right after","c":false,"ex":"They can install malware in seconds."},{"text":"Yes, IT needs it to fix my computer","c":false,"ex":"IT has admin access, they NEVER need your personal password."},{"text":"Never. Hang up and report it","c":true,"ex":"Correct! This is a common vishing tactic."},{"text":"Only if they know my employee ID","c":false,"ex":"Employee IDs are easily discoverable public information."}]},{"t":"A vendor calls sounding extremely angry, demanding you immediately wire a payment to a new bank account.","opts":[{"text":"Wire the money to calm them down and save the contract","c":false,"ex":"Scammers use anger to bypass your security checks."},{"text":"Transfer a small amount to test the account","c":false,"ex":"You will still lose company funds."},{"text":"Ask your coworker to approve it quickly","c":false,"ex":"Coworkers can't bypass the verification policy either."},{"text":"Tell them you must follow the official verification procedure","c":true,"ex":"Correct! Never let emotion override company policy."}]},{"t":"Someone calls claiming to be from 'Senior Management' (who you've never met) asking for sensitive company data.","opts":[{"text":"Provide the data, you don't want to upset senior management","c":false,"ex":"Scammers rely on your fear of authority."},{"text":"Send the data to their personal email address","c":false,"ex":"Never send company data to personal emails."},{"text":"Ask them technical questions to prove they work here","c":false,"ex":"Scammers do extensive research and might know the answers."},{"text":"Politely hang up and verify their identity through the internal directory","c":true,"ex":"Correct! Always verify authority independently."}]},{"t":"Why might a scammer's call show up as an internal company extension (e.g., 4455)?","opts":[{"text":"Because they are actually hiding inside the building","c":false,"ex":"They are likely in another country."},{"text":"Because the telecom company made a routing error","c":false,"ex":"It's intentional fraud, not an error."},{"text":"They use caller ID spoofing to impersonate internal numbers","c":true,"ex":"Correct! Spoofing can mimic internal extensions easily."},{"text":"Because they stole an employee's physical desk phone","c":false,"ex":"Spoofing software is much easier than physical theft."}]},{"t":"You get a call from 'Microsoft Support' claiming your work laptop is infected and they need remote access.","opts":[{"text":"Ask them for a support ticket number","c":false,"ex":"They will just make a fake number up."},{"text":"Hang up and contact your internal IT department","c":true,"ex":"Correct! All IT issues go through your own company's IT."},{"text":"Grant them access, Microsoft is a trusted company","c":false,"ex":"Microsoft will NEVER call you directly about a virus."},{"text":"Tell them to fix it in the background without access","c":false,"ex":"They can't. Just hang up."}]},{"t":"What is the only acceptable way to verify a phone request to change vendor payment details?","opts":[{"text":"Ask for their manager's name","c":false,"ex":"Scammers can look up manager names on LinkedIn."},{"text":"Ask the caller to send an email confirming it","c":false,"ex":"The scammer controls the email too!"},{"text":"Check if the caller's voice sounds familiar","c":false,"ex":"AI voice cloning makes voices unreliable."},{"text":"Call the vendor back using a trusted number from your internal system","c":true,"ex":"Correct! The 'Call-Back' method is the gold standard."}]}];
