...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"You receive an SMS claiming your salary is suspended and you must update data via 'hr-company.com'. What do you do?","opts":[{"text":"Reply with your employee ID to verify","c":false,"ex":"Never share information with unverified numbers."},{"text":"Update it quickly so you get paid","c":false,"ex":"HR NEVER sends data update links via SMS!"},{"text":"Forward it to your manager","c":false,"ex":"Managers aren't equipped to handle malware links, report to IT."},{"text":"Do not click, and report it to IT Security","c":true,"ex":"Correct! This is a smishing attack targeting employees."}]},{"t":"An SMS arrives on your personal phone saying 'Your company O365 account is expiring'. Is it real?","opts":[{"text":"Yes, if it has a Microsoft URL","c":false,"ex":"The URL might look real (e.g., micr0soft.com) but is fake."},{"text":"No, it's a fake link to steal your corporate credentials","c":true,"ex":"Correct! Scammers target personal phones to bypass corporate firewalls."},{"text":"Yes, Microsoft uses SMS for alerts","c":false,"ex":"Enterprise O365 issues are handled through your IT portal."},{"text":"Maybe, wait to see if your email stops working","c":false,"ex":"Don't wait, report the phishing attempt immediately."}]},{"t":"An SMS with a link asks you to download the 'new urgent company VPN update'. Should you?","opts":[{"text":"Yes, VPNs are critical for security","c":false,"ex":"Updates should only be installed from official company portals."},{"text":"Only download it if you are on company Wi-Fi","c":false,"ex":"Downloading malware is dangerous on any network."},{"text":"Wait 24 hours to see if it's real","c":false,"ex":"Report it immediately, don't just ignore it."},{"text":"No, call IT to verify","c":true,"ex":"Correct! This link will likely download ransomware."}]},{"t":"Why are scammers increasingly targeting employees via SMS (Smishing) instead of email?","opts":[{"text":"Because SMS is more secure than email","c":false,"ex":"SMS is actually less secure and lacks phishing protection."},{"text":"Because SMS is cheaper to send","c":false,"ex":"Cost isn't the issue; bypassing security is."},{"text":"To give employees faster updates","c":false,"ex":"Scammers want to steal from you, not help you."},{"text":"Because personal phones lack corporate spam filters and firewalls","c":true,"ex":"Correct! Your personal SMS isn't protected by company IT."}]},{"t":"What is the 'Golden Rule' when receiving unexpected work-related links via SMS?","opts":[{"text":"Some links could be real, so check them quickly","c":false,"ex":"Companies use official channels, not random SMS links."},{"text":"Always trust messages if they mention your company name","c":false,"ex":"Company names are public knowledge."},{"text":"Never use your personal phone for work","c":false,"ex":"You can use it, but you must be extremely cautious."},{"text":"SMS + Link + Urgent Work Action = Highly Suspicious!","c":true,"ex":"Correct! Treat all such messages as hostile."}]},{"t":"If you receive a suspicious work-related SMS on your personal phone, what is the best response?","opts":[{"text":"Reply asking who it is","c":false,"ex":"Replying confirms your number is active and ready for more spam."},{"text":"Do not click links, take a screenshot, and report it to IT","c":true,"ex":"Correct! IT can block the domains to protect others."},{"text":"Click the link but don't type any passwords","c":false,"ex":"Clicking can install malware silently (zero-click attacks)."},{"text":"Ignore it since it's your personal phone","c":false,"ex":"It could still compromise your work data or network."}]}];
