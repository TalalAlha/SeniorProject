/**
 * PhishAware_V5_AR.jsx — Interactive SMS phishing (smishing) remediation training lesson (Arabic, employee).
 *
...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"دق عليك الدعم الفني (IT) حق الشركة يطلب باسوردك عشان يحل مشكلة بجهازك، تعطيه؟","opts":[{"text":"أعطيه إياه إذا كان يعرف رقمي الوظيفي","c":false,"ex":"رقمك الوظيفي سهل أي أحد يعرفه."},{"text":"مستحيل. أقفل الخط وأبلغ عن المكالمة","c":true,"ex":"بطل! هذا أسلوب معروف لاختراق حسابات الموظفين."},{"text":"أعطيه بس أغيره أول ما يخلص","c":false,"ex":"بثواني يقدر يزرع برامج خبيثة في شبكة الشركة."},{"text":"إيه، الـ IT يحتاجونه عشان يصلحون جهازي","c":false,"ex":"الدعم الفني عندهم صلاحيات مدير، مستحيل يطلبون رقمك السري."}]},{"t":"مورد يتصل بك وهو معصب ويقول حوّلوا الدفعة الحين على حسابنا الجديد ولا بنلغي العقد، وش بتسوي؟","opts":[{"text":"أحوّل مبلغ بسيط أجرب الحساب","c":false,"ex":"بتكون ضيعت أموال الشركة على محتال."},{"text":"أحوّل الفلوس عشان أهديه وأحفظ العقد","c":false,"ex":"المحتالين يستخدمون الغضب عشان يخلونك تتجاوز الحماية."},{"text":"أخلي زميلي يوافق عليها بسرعة","c":false,"ex":"زميلك بعد ما يقدر يتجاوز سياسة التحقق."},{"text":"أقول له لازم أتبع إجراءات الشركة الرسمية للتحقق","c":true,"ex":"صح عليك! لا تخلي المشاعر تلغي سياسات الشركة."}]},{"t":"شخص اتصل يدعي إنه من الإدارة العليا (ما قد قابلته) ويطلب معلومات حساسة عن الشركة فوراً.","opts":[{"text":"أسأله أسئلة تقنية عشان أختبره","c":false,"ex":"المحتالين يدرسون الشركة زين وممكن يجاوبونك."},{"text":"أرسل المعلومات لإيميله الشخصي","c":false,"ex":"ممنوع قطعاً إرسال بيانات الشركة لإيميلات شخصية."},{"text":"أعطيه المعلومات، ما أبي أزعل الإدارة","c":false,"ex":"المحتالين يستغلون خوفك من المدراء الكبار."},{"text":"أعتذر بلباقة وأتأكد من هويته عبر الدليل الداخلي للشركة","c":true,"ex":"ممتاز! دايم تأكد من الصلاحيات بشكل مستقل."}]},{"t":"ليش المحتالين أحياناً يقدرون يتصلون عليك ويطلع لك رقم داخلي للشركة (مثلاً تحويلة 4455)؟","opts":[{"text":"لأنهم متخَبّين داخل مبنى الشركة","c":false,"ex":"غالباً هم في دولة ثانية أصلاً."},{"text":"يستخدمون برامج تزوير (Spoofing) لتقليد الأرقام الداخلية","c":true,"ex":"صح! التزوير يقدر يقلد حتى التحويلات الداخلية."},{"text":"لأن شركة الاتصالات غلطت في التوجيه","c":false,"ex":"هذا نصب متعمد، مو غلط من الاتصالات."},{"text":"لأنهم سرقوا تليفون مكتب أحد الموظفين","c":false,"ex":"برامج التزوير أسهل بكثير من سرقة تليفون."}]},{"t":"اتصل عليك واحد يقول إنه من (مايكروسوفت) وفيه فايروس بجهازك ولازم يدخل عليه عن بُعد، تصدقه؟","opts":[{"text":"أطلب منه رقم تذكرة الدعم الفني","c":false,"ex":"بيقوم يألف لك أي رقم من راسه."},{"text":"أقفل الخط وأدق على قسم الـ IT في شركتي","c":true,"ex":"صح! أي مشكلة تقنية تنحل داخلياً عبر الـ IT حقكم."},{"text":"أقول له نظف الفايروس بس بدون ما تدخل جهازي","c":false,"ex":"ما يقدر، هو أصلاً يبي يخترق جهازك، قفل الخط."},{"text":"إيه، مايكروسوفت شركة ثقة","c":false,"ex":"مايكروسوفت مستحيل تتصل عليك شخصياً عشان فايروس."}]},{"t":"كيف تتأكد من أي طلب تغيير حساب بنكي يوصلك بالتليفون من مورد؟","opts":[{"text":"أسأله عن اسم مديره المباشر","c":false,"ex":"يقدر يطلع اسم مديره من لينكد إن بثواني."},{"text":"أطلب منه يرسل إيميل يأكد الطلب","c":false,"ex":"المحتال مخترق الإيميل أصلاً وبيأكد لك!"},{"text":"أقفل وأدق أنا على المورد من الرقم المعتمد في نظامنا","c":true,"ex":"كفو! سياسة (إعادة الاتصال) هي الحل الوحيد المعتمد."},{"text":"أتأكد إذا صوته مألوف","c":false,"ex":"الذكاء الاصطناعي صار يقلد الأصوات بالملي."}]}];
