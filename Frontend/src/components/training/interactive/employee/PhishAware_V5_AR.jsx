...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"\"المدير\" يطلب تحويل 35,000 سري — ماذا تفعل؟","opts":[{"text":"أحوّل فوراً","c":false,"ex":"تحقق دائماً عبر قناة أخرى!"},{"text":"أتصل بالمدير بالرقم المعروف","c":true,"ex":"صحيح!"}]},{"t":"\"IT\" يطلب كلمة مرورك لإصلاح فيروس — تعطيه؟","opts":[{"text":"نعم","c":false,"ex":"IT لن يطلب كلمة مرورك أبداً!"},{"text":"لا أبداً","c":true,"ex":"صحيح!"}]},{"t":"المورد يغير حسابه هاتفياً — ماذا تفعل؟","opts":[{"text":"أحدّث المعلومات","c":false,"ex":"لا تغير الدفع هاتفياً فقط!"},{"text":"أتصل بالمورد وأطلب تأكيد خطي","c":true,"ex":"صحيح!"}]},{"t":"هل يمكن تزوير Caller ID؟","opts":[{"text":"لا","c":false,"ex":"يمكن تزويره بسهولة!"},{"text":"نعم","c":true,"ex":"صحيح!"}]},{"t":"كيف تتحقق من متصل يدعي أنه من قسم تقنية المعلومات؟","opts":[{"text":"تطلب منه رقمه الوظيفي","c":false,"ex":"يمكنهم تزييف الرقم الوظيفي بسهولة."},{"text":"تتصل برقم الدعم الفني الرسمي","c":true,"ex":"صحيح! استخدم الأرقام الداخلية المعتمدة دائماً."}]},{"t":"إذا اتصل مورد بخصوص تغييرات بنكية عاجلة، ما هي أفضل سياسة؟","opts":[{"text":"اتباع إجراءات التحقق المعتمدة","c":true,"ex":"صحيح! التزم بسياسة الشركة."},{"text":"إجراء التغيير بسرعة لتجنب التأخير","c":false,"ex":"السرعة قد تؤدي إلى أخطاء مكلفة."}]}];
