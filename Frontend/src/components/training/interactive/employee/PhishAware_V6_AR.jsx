...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"وصلتك رسالة SMS تقول 'تم إيقاف راتبك، حدّث بياناتك عبر hr-company.com'، وش بتسوي؟","opts":[{"text":"ما أضغط الرابط وأبلغ أمن المعلومات (IT)","c":true,"ex":"صح! هذي هجمة تصيد تستهدف الموظفين."},{"text":"أرد برقمي الوظيفي عشان يتأكدون","c":false,"ex":"لا تشارك معلوماتك مع أرقام غير موثوقة أبداً."},{"text":"أرسلها لمديري يشوف لها صرفة","c":false,"ex":"المدراء مو مسؤولين عن فحص الفايروسات، بلغ الـ IT."},{"text":"أحدّث بياناتي بسرعة عشان ينزل الراتب","c":false,"ex":"الـ HR مستحيل يرسلون تحديث بيانات حساسة برابط SMS!"}]},{"t":"جتك رسالة على جوالك الخاص تقول اشتراك الأوفيس 365 حق الشركة بينتهي، حقيقية؟","opts":[{"text":"أنتظر يومين أشوف إذا قفل الإيميل صدق","c":false,"ex":"لا تنتظر، أبلغ عن محاولة الاختراق فوراً."},{"text":"إيه، مايكروسوفت تستخدم رسايل الجوال","c":false,"ex":"مشاكل حسابات الشركة تنحل عبر بوابة الـ IT مو رسايل الجوال."},{"text":"إيه، إذا كان الرابط فيه كلمة Microsoft","c":false,"ex":"الروابط تتزور بسهولة (مثلاً Micr0soft.com)."},{"text":"لا، هذا رابط وهمي لسرقة إيميل الشركة","c":true,"ex":"كفو! المحتالين يستهدفون جوالك الخاص لأنه بدون حماية الـ IT."}]},{"t":"رسالة فيها رابط تقول لك نزل التحديث الجديد والضروري لـ VPN الشركة، وش السواة؟","opts":[{"text":"أحمّله، الـ VPN ضروري لأمان الشركة","c":false,"ex":"تحديثات برامج الشركة تنزل من البوابة الرسمية مو من رابط SMS."},{"text":"أحمّله بس إذا كنت شابك على واي فاي الشركة","c":false,"ex":"تحميل البرامج الضارة خطير على أي شبكة!"},{"text":"لا، أتصل بالـ IT أتأكد منهم","c":true,"ex":"صح عليك! غالباً الرابط بينزل لك (برامج فدية) تخترق جهازك."},{"text":"أنتظر 24 ساعة أشوف إذا زملائي حدثوا","c":false,"ex":"بلغ الـ IT فوراً عشان يحذرون باقي الموظفين."}]},{"t":"ليش المحتالين صاروا يستهدفون الموظفين برسايل SMS بدل الإيميلات؟","opts":[{"text":"لأن رسايل الـ SMS أرخص لهم","c":false,"ex":"الهدف هو تجاوز الحماية، مو تقليل التكلفة."},{"text":"عشان يوصلون التحديثات للموظفين أسرع","c":false,"ex":"المحتال يبي يسرقك، مو مهتم يوصلك تحديثات!"},{"text":"لأن الـ SMS أكثر أماناً وما تتهكر","c":false,"ex":"الـ SMS أقل أماناً وما فيها حماية من التصيد."},{"text":"لأن الجوال الخاص ما فيه فلاتر وحماية زي إيميل الشركة","c":true,"ex":"بالضبط! جوالك الخاص يعتبر ثغرة للوصول للشركة."}]},{"t":"وش (القاعدة الذهبية) لو وصلك رابط يخص الشغل على رسالة نصية (SMS)؟","opts":[{"text":"أثق بالرسالة إذا كان مكتوب فيها اسم شركتي","c":false,"ex":"اسم شركتك معروف وموجود بالنت للكل."},{"text":"أفتح الرابط بسرعة أتأكد منه وأطلع","c":false,"ex":"مجرد فتح الرابط ممكن يثبت فايروس بجهازك."},{"text":"رسالة + رابط + طلب عاجل للشغل = نصب واحتيال!","c":true,"ex":"صح! عامل أي رسالة بهالشكل على إنها هجوم."},{"text":"ممنوع أستخدم جوالي الخاص للشغل نهائياً","c":false,"ex":"تقدر تستخدمه، بس لازم تكون حذر جداً."}]},{"t":"لو جتك رسالة مجهولة تخص الشغل على جوالك الشخصي، وش أحسن تصرف؟","opts":[{"text":"أرد عليهم أسأل (من معي؟)","c":false,"ex":"الرد يؤكد للمحتال إن رقمك شغال وبيزعجك زيادة."},{"text":"أضغط الرابط بس ما أكتب أي باسورد","c":false,"ex":"الضغط ممكن يثبّت برامج خبيثة بصمت (Zero-click)."},{"text":"ما أضغط أي رابط، أصور الشاشة وأبلغ الـ IT","c":true,"ex":"ممتاز! الـ IT يقدرون يحجبون الرابط عن باقي الموظفين."},{"text":"أتجاهلها تماماً لأنها على جوالي الشخصي","c":false,"ex":"قد تعرض بيانات العمل اللي بجوالك للخطر، لازم تبلغ."}]}];
