/**
 * PhishAware_V4_EN.jsx — Interactive email phishing remediation training lesson (English, employee).
 *
...
function Scene6({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"Your CEO sends an urgent email asking you to buy iTunes/Jarir gift cards for a client. What do you do?","opts":[{"text":"Reply to the email asking if it's really them","c":false,"ex":"The scammer controls the email, they will just say 'Yes'."},{"text":"Forward the email to the client directly","c":false,"ex":"Don't involve clients in internal security issues."},{"text":"Buy them immediately to impress the CEO","c":false,"ex":"This is a classic Business Email Compromise (BEC) scam!"},{"text":"Call the CEO or talk to them in person to verify","c":true,"ex":"Correct! Always verify unusual requests out-of-band."}]},{"t":"You receive an email from 'Qiwa' or 'GOSI' demanding urgent login to update employee records.","opts":[{"text":"Click the link but use a fake password first","c":false,"ex":"They can still capture session cookies or IP data."},{"text":"Check the sender's actual email address carefully","c":true,"ex":"Correct! It's likely a fake domain like 'qiw-sa.com'."},{"text":"Forward it to all employees so they can update it","c":false,"ex":"Never forward unverified links to colleagues."},{"text":"Log in quickly to avoid company penalties","c":false,"ex":"Scammers use fear of penalties to steal credentials."}]},{"t":"A regular supplier emails you saying their Saudi IBAN has changed and future payments must go there.","opts":[{"text":"Process only half the payment to test it","c":false,"ex":"You will still lose half the money!"},{"text":"Ask them to send a scanned signed letter","c":false,"ex":"Signatures and letterheads are easily forged."},{"text":"Call the supplier's known phone number to verify","c":true,"ex":"Correct! Phone verification is mandatory for IBAN changes."},{"text":"Update the ERP system immediately to avoid delays","c":false,"ex":"Never change financial details based solely on an email."}]},{"t":"HR sends an email asking for your corporate password to 'migrate your email to a new server'.","opts":[{"text":"Send it, HR is a trusted department","c":false,"ex":"No legitimate department will EVER ask for your password."},{"text":"Send them your old password instead","c":false,"ex":"Don't engage with the attacker at all."},{"text":"Only send it if the IT manager is CC'd","c":false,"ex":"The CC'd address is likely fake too."},{"text":"Report the email to IT Security immediately","c":true,"ex":"Correct! This is a phishing attack targeting employees."}]},{"t":"An email says 'Secret + Urgent + Don't tell anyone'. This is a major red flag for what type of attack?","opts":[{"text":"A generic newsletter","c":false,"ex":"Newsletters are not secret."},{"text":"A confidential HR promotion","c":false,"ex":"HR doesn't operate like a spy movie."},{"text":"A standard non-disclosure agreement","c":false,"ex":"NDAs go through legal channels, not secret emails."},{"text":"Business Email Compromise (BEC)","c":true,"ex":"Correct! Secrecy and urgency isolate the victim."}]},{"t":"What is the most effective way to spot a spoofed internal email?","opts":[{"text":"Look for spelling mistakes","c":false,"ex":"AI tools make phishing emails perfectly spelled now."},{"text":"Check if the company logo looks slightly blurry","c":false,"ex":"Scammers can copy high-quality logos easily."},{"text":"See if the email was sent during business hours","c":false,"ex":"Scammers can schedule emails to arrive at 9 AM."},{"text":"Expand the 'From' field to see the actual email address","c":true,"ex":"Correct! The display name might say 'CEO', but the email is 'ceo@gmail.com'."}]}];
