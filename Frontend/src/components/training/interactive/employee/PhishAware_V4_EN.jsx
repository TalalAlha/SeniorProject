...
function Scene6({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"CEO emails: urgent secret 50K transfer — what to do?","opts":[{"text":"Transfer immediately","c":false,"ex":"Always verify through another channel!"},{"text":"Call CEO to verify","c":true,"ex":"Correct!"}]},{"t":"Supplier changes bank account via email — normal?","opts":[{"text":"Yes, happens sometimes","c":false,"ex":"Never change payment info via email alone!"},{"text":"No, must verify by phone","c":true,"ex":"Correct!"}]},{"t":"HR asks for your password via email — send it?","opts":[{"text":"No — HR never asks for passwords","c":true,"ex":"Correct!"},{"text":"Yes, for GOSI update","c":false,"ex":"No one will ever ask for your password!"}]},{"t":"'Secret + Urgent + Don't tell anyone' — sign of?","opts":[{"text":"Important deal","c":false,"ex":"Classic BEC scam pattern!"},{"text":"BEC fraud","c":true,"ex":"Correct!"}]},{"t":"What is a common sign of a Business Email Compromise (BEC) attack?","opts":[{"text":"A request to change payment details","c":true,"ex":"Correct! Always verify changes by phone."},{"text":"A generic newsletter","c":false,"ex":"Newsletters are usually harmless."}]},{"t":"If an email seems to come from your CEO asking for gift cards, you should:","opts":[{"text":"Buy them immediately","c":false,"ex":"CEOs rarely ask for gift cards via email."},{"text":"Report the email to IT","c":true,"ex":"Correct! This is a classic scam."}]}];
