...
function Scene6({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"المدير يطلب تحويل 50,000 سري عاجل — ماذا تفعل؟","opts":[{"text":"أحوّل فوراً","c":false,"ex":"تحقق دائماً عبر قناة أخرى!"},{"text":"أتصل بالمدير للتحقق","c":true,"ex":"صحيح!"}]},{"t":"المورد يغير حسابه البنكي عبر الإيميل — طبيعي؟","opts":[{"text":"نعم","c":false,"ex":"لا تغير معلومات الدفع بناءً على إيميل!"},{"text":"لا، يجب التحقق هاتفياً","c":true,"ex":"صحيح!"}]},{"t":"HR تطلب كلمة مرورك عبر إيميل — ترسلها؟","opts":[{"text":"لا — HR لن تطلبها أبداً","c":true,"ex":"صحيح!"},{"text":"نعم لتحديث GOSI","c":false,"ex":"لن يطلب أحد كلمة مرورك!"}]},{"t":"\"سري + عاجل + لا تخبر أحد\" — علامة على؟","opts":[{"text":"صفقة مهمة","c":false,"ex":"هذا نمط احتيال BEC الكلاسيكي!"},{"text":"احتيال BEC","c":true,"ex":"صحيح!"}]},{"t":"ما هي العلامة الشائعة لهجوم اختراق البريد الإلكتروني للشركات (BEC)؟","opts":[{"text":"طلب تغيير تفاصيل الدفع","c":true,"ex":"صحيح! تحقق دائماً عبر الهاتف."},{"text":"نشرة إخبارية عامة","c":false,"ex":"النشرات الإخبارية عادة غير ضارة."}]},{"t":"إذا وصلك إيميل يبدو من المدير التنفيذي يطلب بطاقات هدايا، يجب عليك:","opts":[{"text":"شراؤها فوراً","c":false,"ex":"المدراء نادراً ما يطلبون بطاقات هدايا عبر الإيميل."},{"text":"الإبلاغ عن الإيميل لتقنية المعلومات","c":true,"ex":"صحيح! هذا احتيال كلاسيكي."}]}];
