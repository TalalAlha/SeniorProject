...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"وصلتك رسالة من البريد السعودي (سبل) تقول شحنتك موقفه ولازم تدفع 10 ريال رسوم عبر الرابط، وش تسوي؟","opts":[{"text":"أرسل الرابط لأخوي يدفعها عني","c":false,"ex":"كذا بتورط أخوك وتنسرق بطاقته!"},{"text":"أدفعها، 10 ريال مبلغ بسيط ما يضر","c":false,"ex":"هم ما يبون الـ 10 ريال، يبون يسرقون معلومات بطاقتك وتنسحب كل فلوسك!"},{"text":"أدفعها يمكن أحد مرسل لي هدية","c":false,"ex":"لا تطيح بالفخ، المحتالين يلعبون على الفضول."},{"text":"أتجاهلها لأن هذا نصب واستدراج لسرقة البطاقة","c":true,"ex":"صح! سبل ما تطلب رسوم بهالطريقة أبداً."}]},{"t":"جتك رسالة مكتوب فيها 'هيئة الزكاة والضريبة والجمارك: عليك فاتورة مستحقة' وفيها رابط bit.ly، تفتحه؟","opts":[{"text":"أفتحه بس إذا كان جوالي أيفون لأنه آمن","c":false,"ex":"الاحتيال المالي يخترق بطاقتك مو شرط يخترق جهازك."},{"text":"إيه، فواتير الضريبة مهمة ولازم تتسدد","c":false,"ex":"الهيئة ما تستخدم روابط bit.ly المختصرة أبداً."},{"text":"لا، أدخل موقع الهيئة الرسمي من المتصفح وأتأكد","c":true,"ex":"كفو! دايم تجاوز الرابط وادخل المصدر الأساسي."},{"text":"أفتحه وأشوف كم المبلغ بس ما أدفع","c":false,"ex":"مجرد فتح الرابط ممكن يكون خطير."}]},{"t":"ليش المحتالين دايم يستخدمون روابط مختصرة زي bit.ly أو غيره في رسايلهم؟","opts":[{"text":"عشان يخفون الرابط الحقيقي الوهمي عن عينك","c":true,"ex":"صح! الرابط المختصر يمنعك تشوف اسم الموقع المزيف."},{"text":"عشان رسوم الـ SMS تكون أرخص عليهم","c":false,"ex":"مو هذا السبب الرئيسي، هدفهم الإخفاء."},{"text":"عشان يفتح الموقع بشكل أسرع","c":false,"ex":"الروابط المختصرة تاخذ وقت أطول لأنها تحولك لموقع ثاني."},{"text":"لأنها تعطي طابع احترافي ورسمي للرسالة","c":false,"ex":"بالعكس، الجهات الرسمية ما تستخدمها."}]},{"t":"وش السواة لو وصلتك رسالة من شركة شحن (مثل أرامكس أو سمسا) وأنت أصلاً ما طلبت شي؟","opts":[{"text":"أدفع الرسوم، يمكن غرض ناسي إني طلبته","c":false,"ex":"هذا فخ، المحتال يرسل لآلاف الناس عشوائياً."},{"text":"أرد عليهم بكلمة 'مين أنتم؟'","c":false,"ex":"الرد يثبت لهم إن رقمك شغال ويستهدفونك أكثر."},{"text":"أطنشها تماماً لأنها رسالة احتيال عشوائية","c":true,"ex":"ممتاز! لا تتفاعل معها أبداً."},{"text":"أضغط الرابط أشوف وش الشحنة بس","c":false,"ex":"الرابط ممكن يحمل برامج خبيثة على جهازك."}]},{"t":"رسالة فيها كود تفعيل وأنت جالس تسولف ما سويت شي.. وش معناها؟","opts":[{"text":"شخص يعرف رقمك السري ويحاول يدخل حسابك","c":true,"ex":"صح! الكود هذا هو اللي مانعه، غيّر رقمك السري فوراً."},{"text":"غلطة من النظام حق شركة الاتصالات","c":false,"ex":"شركات الاتصالات ما ترسل أكواد بنوك بالغلط."},{"text":"تحديث تلقائي من البنك","c":false,"ex":"البنك ما يرسل كود تفعيل لتحديث تلقائي."},{"text":"رسالة قديمة توها توصل","c":false,"ex":"أكواد التفعيل وقتها قصير وما تتأخر كذا."}]},{"t":"كيف تتأكد إن رسالة التوصيل اللي وصلتك صدق مو نصب؟","opts":[{"text":"أشوف إذا اسم المرسل (SMSA) مكتوب فوق","c":false,"ex":"اسم المرسل (Sender ID) يتزور بسهولة جداً."},{"text":"أفتح تطبيق الشركة الرسمي وأحط رقم الشحنة","c":true,"ex":"صح عليك! هذي أضمن وأأمن طريقة."},{"text":"أدق على الرقم اللي أرسل لي الرسالة","c":false,"ex":"الرقم غالباً حق المحتال وبيقنعك تدفع."},{"text":"أشوف إذا الرابط يبدأ بـ HTTPS","c":false,"ex":"حتى مواقع المحتالين صار فيها HTTPS وقفل أخضر!"}]}];
