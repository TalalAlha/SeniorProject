...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"رسالة سمسا برابط smsa-sa.net — حقيقية؟","opts":[{"text":"نعم","c":false,"ex":"smsa-sa.net ليس الدومين الرسمي!"},{"text":"لا، مزيفة","c":true,"ex":"صحيح!"}]},{"t":"فاتورة كهرباء تهدد بالقطع خلال 24 ساعة؟","opts":[{"text":"أدفع فوراً","c":false,"ex":"SEC لا تقطع بدون إنذار!"},{"text":"أفتح تطبيق SEC","c":true,"ex":"صحيح!"}]},{"t":"وصلك رمز نفاذ لم تطلبه — ماذا يعني؟","opts":[{"text":"خطأ تقني","c":false,"ex":"شخص يحاول اختراق حسابك!"},{"text":"محاولة اختراق!","c":true,"ex":"صحيح!"}]},{"t":"رابط bit.ly من جهة رسمية — آمن؟","opts":[{"text":"نعم","c":false,"ex":"الروابط المختصرة قد تخفي روابط خبيثة!"},{"text":"لا، خطير","c":true,"ex":"صحيح!"}]},{"t":"لماذا يستخدم المحتالون الروابط المختصرة مثل bit.ly؟","opts":[{"text":"لإخفاء الوجهة الحقيقية","c":true,"ex":"صحيح! احذر دائماً من الروابط المختصرة."},{"text":"لتوفير المساحة في الرسالة","c":false,"ex":"يستخدمونها لإخفاء الروابط الخبيثة!"}]},{"t":"هل يجب أن تدفع رسوماً بسيطة لاستلام شحنة لم تطلبها؟","opts":[{"text":"نعم، قد تكون هدية","c":false,"ex":"هذا احتيال شائع في التوصيل!"},{"text":"لا، تجاهلها","c":true,"ex":"صحيح! لا تدفع لشحنات غير متوقعة."}]}];
