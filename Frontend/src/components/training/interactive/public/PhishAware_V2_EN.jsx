...
function PhoneSMS({ label, type, sender, message, time, children }) {
  ...
  return (
    <div style={{ maxWidth: 340, margin: "0 auto", borderRadius: 28, overflow: "hidden", border: `2px solid ${bc}`, background: "#0F172A", boxShadow: `0 0 24px ${type === "fake" ? "rgba(239,68,68,0.1)" : "rgba(16,185,129,0.1)"}` }}>
