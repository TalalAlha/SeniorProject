...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"Someone calls claiming to be from the 'Ministry of Interior' about unpaid fees. What do you do?","opts":[{"text":"Pay immediately to avoid arrest","c":false,"ex":"The government never demands payment over a phone call."},{"text":"Argue with them to prove they are fake","c":false,"ex":"Don't waste time, just hang up."},{"text":"Hang up and check Absher for any real violations","c":true,"ex":"Correct! Official portals are the only way to check."},{"text":"Ask them to send you a payment link on WhatsApp","c":false,"ex":"They will send you a phishing link!"}]},{"t":"You receive a call from the 'Central Bank' (SAMA) asking for your OTP to protect your account. Is this normal?","opts":[{"text":"Only if I actually lost my card recently","c":false,"ex":"Even then, banks don't ask for OTPs over the phone."},{"text":"Yes, SAMA protects citizens from fraud","c":false,"ex":"SAMA will NEVER call you asking for OTPs!"},{"text":"Yes, if they correctly state my ID number","c":false,"ex":"Scammers can buy leaked ID numbers."},{"text":"No, this is a clear vishing fraud attempt","c":true,"ex":"Correct! Never share your OTP with anyone calling you."}]},{"t":"A caller tells you: 'You won 100,000 SAR from STC! Just pay a 500 SAR transfer fee.'","opts":[{"text":"Ask them to deduct the fee from the prize","c":false,"ex":"They can't, because the prize doesn't exist!"},{"text":"It's a scam — I didn't enter any competition","c":true,"ex":"Correct! Real prizes never require you to pay a fee first."},{"text":"Provide your IBAN immediately","c":false,"ex":"They will use your IBAN for further scams."},{"text":"Pay the fee, it's a small risk for a big reward","c":false,"ex":"You will lose your 500 SAR and get nothing."}]},{"t":"Can a scammer make their phone number appear as an official bank number on your screen (Caller ID Spoofing)?","opts":[{"text":"Only if they hack into the telecom network","c":false,"ex":"They don't need to hack the network, they just use VoIP apps."},{"text":"No, telecoms strictly block this","c":false,"ex":"Telecoms try, but spoofing is still very common globally."},{"text":"Yes, Caller ID can be easily faked using cheap software","c":true,"ex":"Correct! Never trust the caller ID blindly."},{"text":"Only for international calls, not local","c":false,"ex":"They can spoof local Saudi numbers too!"}]},{"t":"A 'bank investigator' calls about a suspicious charge and needs your card's CVV to cancel it.","opts":[{"text":"Hang up and call the bank yourself","c":true,"ex":"Correct! Take control and initiate the call yourself."},{"text":"Give it to them so they can stop the charge","c":false,"ex":"Banks DO NOT need your CVV to cancel transactions!"},{"text":"Ask them to verify your recent purchases first","c":false,"ex":"They might have stolen your purchase history too."},{"text":"Give them a fake CVV to test them","c":false,"ex":"Don't engage, just hang up."}]},{"t":"Why do vishing scammers often create a sense of extreme urgency or fear during the call?","opts":[{"text":"To show they care about your security","c":false,"ex":"They only care about stealing your money."},{"text":"To make you panic and skip verifying their identity","c":true,"ex":"Correct! Fear shuts down critical thinking."},{"text":"Because they have a strict call quota","c":false,"ex":"They just want you to make a mistake quickly."},{"text":"Because banking systems close early","c":false,"ex":"Banks operate 24/7 for fraud prevention."}]}];
