...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs =[{"t":"شخص يتصل من \"وزارة الداخلية\" عن مخالفة — ماذا تفعل؟","opts":[{"text":"أدفع فوراً","c":false,"ex":"الحكومة لا تطلب الدفع عبر الهاتف!"},{"text":"أغلق وأتحقق من أبشر","c":true,"ex":"صحيح!"}]},{"t":"البنك يطلب رقم CVV عبر الهاتف — طبيعي؟","opts":[{"text":"نعم للتحقق","c":false,"ex":"البنوك لا تطلب CVV أبداً عبر الهاتف!"},{"text":"لا، هذا احتيال","c":true,"ex":"صحيح!"}]},{"t":"\"فزت بـ 100,000! ادفع 500 رسوم\" — ما رأيك؟","opts":[{"text":"احتيال — لم أشترك","c":true,"ex":"صحيح! الجوائز الحقيقية لا تطلب رسوم."},{"text":"ممكن حقيقي","c":false,"ex":"إذا لم تشترك، لم تفز!"}]},{"t":"هل يمكن تزوير هوية المتصل؟","opts":[{"text":"لا، دائماً دقيق","c":false,"ex":"يمكن تزوير Caller ID بسهولة!"},{"text":"نعم، يمكن تزويره","c":true,"ex":"صحيح!"}]},{"t":"هل يمكن للمحتال استخدام شعار مؤسسة حقيقية لخداعك؟","opts":[{"text":"نعم، ينسخونها بسهولة","c":true,"ex":"صحيح! الشعارات يسهل نسخها."},{"text":"لا، الشعارات محمية","c":false,"ex":"المحتالون يسرقون الشعارات لتبدو حقيقية."}]},{"t":"إذا ضغط عليك شخص للتصرف فوراً، ماذا تفعل؟","opts":[{"text":"أتصرف بسرعة لأكون آمناً","c":false,"ex":"الضغط والاستعجال علامة حمراء!"},{"text":"أتوقف وأتحقق","c":true,"ex":"صحيح! المحتالون يخلقون استعجالاً وهمياً."}]}];
