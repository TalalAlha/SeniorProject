...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"دق عليك واحد يقول إنه من وزارة الداخلية وعليك إيقاف خدمات، وش بتسوي؟","opts":[{"text":"أدفع المخالفة بسرعة عشان ما انمسك","c":false,"ex":"غلط! الجهات الحكومية ما تطلب فلوس بمكالمة جوال."},{"text":"أهاوشه عشان أثبت إنه نصاب","c":false,"ex":"لا تضيع وقتك معهم، قفل بوجهه أحسن."},{"text":"أقول له يرسل لي رابط السداد واتساب","c":false,"ex":"بيرسل لك رابط وهمي يسرق فلوسك."},{"text":"أقفل الخط وأدخل أبشر أشوف إذا علي شي صدق","c":true,"ex":"عز الله إنك ذيب! أبشر هو الفيصل."}]},{"t":"اتصل بك شخص يدعي إنه من البنك المركزي (مؤسسة النقد) يبي كود النفاذ لتحديث بياناتك، تعطيه؟","opts":[{"text":"أعطيه إذا كان يعرف رقم بطاقة الأحوال حقتي","c":false,"ex":"تراهم يشترون أرقام الهويات المسربة عادي."},{"text":"إيه، البنك المركزي يحمينا من النصب","c":false,"ex":"البنك المركزي مستحيل يدق عليك يطلب أكواد!"},{"text":"لا طبعاً، هذا احتيال مالي واضح (Vishing)","c":true,"ex":"كفو! الأكواد هذي لك أنت وبس."},{"text":"بس إذا بطاقتي الصرافة ضايعة قريب","c":false,"ex":"حتى لو ضايعة، البنك ما يطلب الكود بالتليفون."}]},{"t":"لو دق عليك واحد قال مبروك ربحت 100 ألف من الاتصالات، بس حوّل 500 ريال رسوم تحويل..","opts":[{"text":"نصابين! أنا أصلاً ما شاركت بمسابقة","c":true,"ex":"صح عليك! الجوائز الصدقية ما تطلب تدفع لها رسوم."},{"text":"أعطيه الآيبان حقي بس بدون ما أدفع","c":false,"ex":"ممكن يستخدمون الآيبان في نصبات ثانية."},{"text":"أحوّل الـ 500، المخاطرة تستاهل 100 ألف","c":false,"ex":"بتطير الـ 500 ولا أنت بشايف ولا هللة."},{"text":"أقول له اخصم الـ 500 من الجائزة وحوّل الباقي","c":false,"ex":"ما يقدر يخصم لأن الجائزة بكبرها كذبة!"}]},{"t":"هل يمدي المحتالين يغيرون الرقم اللي يطلع لك بالشاشة (Caller ID) عشان يبان إنه رقم بنك رسمي؟","opts":[{"text":"لا مستحيل، شركات الاتصالات مانعة هالشي","c":false,"ex":"شركات الاتصالات تحاول تمنع، بس لسه التزوير منتشر."},{"text":"بس للمكالمات الخارجية، الأرقام السعودية مستحيل","c":false,"ex":"لا، يقدرون يزورون أرقام سعودية وبنوك بعد!"},{"text":"إيه يقدرون، ببرامج رخيصة يزورون الرقم اللي يظهر لك","c":true,"ex":"صح! عشان كذا لا تثق بالرقم اللي طالع بالشاشة."},{"text":"بس إذا قدروا يهكرون شبكة الاتصالات","c":false,"ex":"ما يحتاجون يهكرون الشبكة، يستخدمون برامج اتصال عبر النت."}]},{"t":"دق عليك شخص من 'البنك' وقال فيه عملية مشبوهة بحسابك، وعطني رقم الـ CVV عشان نلغيها، تعطيه؟","opts":[{"text":"أطلب منه يقول لي وش شريت آخر مرة عشان أتأكد","c":false,"ex":"ممكن يكونون مخترقين حسابك وشايفين عملياتك!"},{"text":"إيه أعطيه عشان يوقفون العملية بسرعة","c":false,"ex":"البنك يقدر يوقف العملية بدون ما يسألك عن الـ CVV!"},{"text":"أقفل الخط وأدق أنا على رقم البنك الصدقي","c":true,"ex":"ممتاز! دايم خل المبادرة بالاتصال منك أنت."},{"text":"أعطيه رقم CVV غلط عشان أختبره","c":false,"ex":"لا تسولف معه أصلاً، قفل الخط."}]},{"t":"المحتال دايم يحاول يخليك تستعجل وتخاف وأنت تكلمه (مثل: حسابك بيتقفل الحين)، ليش يسوي كذا؟","opts":[{"text":"عشان ترتبك وتخاف وتنسى تتأكد من هويته","c":true,"ex":"صح! الخوف يخلي الواحد يتصرف بدون ما يفكر زين."},{"text":"لأنه خايف على حسابك من الاختراق","c":false,"ex":"هو بكبره اللي قاعد يحاول يخترق حسابك!"},{"text":"لأن أنظمة البنك تقفل بسرعة","c":false,"ex":"أنظمة البنوك شغالة 24 ساعة لحماية العملاء."},{"text":"عشان عنده مكالمات ثانية يبي يخلصها","c":false,"ex":"هو بس يبيك تغلط بسرعة قبل ما تستوعب."}]}];
