...
function Scene4() {
  ...
  return (<div>
    ...
    <FadeIn delay={5500}><div style={{ marginTop: 20, padding: "16px 20px", borderRadius: 12, textAlign: "center", background: "rgba(220,38,38,0.1)", border: "1px solid rgba(220,38,38,0.3)" }}>
      ...
      <div style={{ color: C.redLight, fontWeight: 700, fontSize: 15, direction: "rtl" }}>لا تشارك رمز نفاذ مع أي شخص — أبداً!</div>
    </div></FadeIn>
...
function Scene6({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"وش بتسوي لو وصلتك رسالة من نفاذ فيها رابط غريب يطلب تحديث بياناتك؟","opts":[{"text":"أطنش الرابط وأدخل تطبيق نفاذ الرسمي لو احتجت","c":true,"ex":"صح عليك! التطبيق الرسمي هو الأضمن."},{"text":"أحوّل الرسالة للبنك حقي","c":false,"ex":"البنك ماله دخل بحسابك في نفاذ."},{"text":"أدخل الرابط على طول عشان ما ينقفل حسابي","c":false,"ex":"غلط! نفاذ ما يرسلون روابط أبداً."},{"text":"أرد على الرسالة وأسألهم عن السبب","c":false,"ex":"الرد يثبت للمحتال إن رقمك شغال."}]},{"t":"جتك رسالة تقول إن حسابك البنكي بيتجمد ولازم تضغط الرابط عشان تحدثه، وش السواة؟","opts":[{"text":"أنتظر يومين أشوف البنك يدقون ولا لا","c":false,"ex":"دق عليهم أنت أحسن لك."},{"text":"أطنش الرابط وأدق على رقم البنك اللي ورا الصرافة","c":true,"ex":"بطل! هذا أحسن تصرف دايم."},{"text":"أضغط الرابط بس ما أكتب رقمي السري","c":false,"ex":"مجرد الضغط ممكن ينزل برامج خبيثة بجوالك!"},{"text":"أرد عليهم برقم هويتي عشان يتأكدون","c":false,"ex":"لا تشارك هويتك في رسايل مجهولة أبداً."}]},{"t":"لو جاك إيميل من أبشر (absher@outlook.com) يقول عندك مخالفة مرورية، وش تسوي؟","opts":[{"text":"أتجاهله لأن أبشر مستحيل يستخدم إيميل outlook","c":true,"ex":"صح! الجهات الحكومية تستخدم نطاق .gov.sa بس."},{"text":"أدفعها احتياط عشان ما تتدبل","c":false,"ex":"بتخسر فلوسك وبياخذون بيانات بطاقتك!"},{"text":"أصدقه إذا كان فيه شعار وزارة الداخلية","c":false,"ex":"سهل جداً ينسخون ويلصقون الشعارات!"},{"text":"أدفعها لو كانت قيمة المخالفة صحيحة","c":false,"ex":"المحتالين يقدرون يخمنون أو يعرفون قيمة المخالفات."}]},{"t":"البنك يرسل لك رسالة فيها كود تفعيل (OTP) وأنت ما سويت شي، وش معناها؟","opts":[{"text":"جوالي فيه فايروس","c":false,"ex":"جوالك سليم، بس حسابك بخطر."},{"text":"مجرد تعليق بالنظام البنكي","c":false,"ex":"الأنظمة ما تعلق كذا، فيه أحد يحاول يدخل حسابك!"},{"text":"رسالة متأخرة من عملية أمس","c":false,"ex":"أكواد الـ OTP تنتهي خلال دقايق، ما تتأخر يوم."},{"text":"فيه شخص معاه رقمك السري ويحاول يدخل حسابك","c":true,"ex":"صح عليك! لازم تغير الباسورد فوراً."}]},{"t":"لو جاك رابط آخره .gov.sa على الواتس اب من رقم غريب، تفتحه؟","opts":[{"text":"إيه، الروابط الحكومية دايم آمنة","c":false,"ex":"الرابط ممكن يكون وهمي ومكتوب بطريقة تخدعك!"},{"text":"أفتحه من اللابتوب بس","c":false,"ex":"الرابط خطير سواء من الجوال أو اللابتوب."},{"text":"أفتحه إذا كان يناديني باسمي الكامل","c":false,"ex":"المحتالين يقدرون يجيبون اسمك بسهولة."},{"text":"لا، أتأكد من المصدر وأتجاهل الأرقام المجهولة","c":true,"ex":"صح! الجهات الحكومية ما تتواصل واتساب من أرقام غريبة."}]},{"t":"وش أحسن طريقة تتأكد فيها من رسالة وصلتك وتدعي إنها من جهة حكومية؟","opts":[{"text":"أرسل الرابط لخويي يشوفه","c":false,"ex":"ممكن خويك ينخدع بعد!"},{"text":"أشيك على الإملاء والتنسيق","c":false,"ex":"المحتالين صاروا يكتبون بدون أخطاء إملائية."},{"text":"أشوف التوقيع الرسمي آخر الإيميل","c":false,"ex":"التوقيع أسهل شي يتزور."},{"text":"أطنش الرسالة وأدخل التطبيق الرسمي (زي توكلنا أو أبشر)","c":true,"ex":"ممتاز! التطبيق الرسمي هو الفيصل."}]}];
