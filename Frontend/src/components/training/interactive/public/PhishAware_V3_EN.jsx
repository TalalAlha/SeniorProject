/**
 * PhishAware_V3_EN.jsx — Interactive voice phishing (vishing) awareness lesson (English, public).
 *
...
function Scene5({ onComplete = () => {} }) {
  ...
  const qs = [{"t":"You receive an SMS from 'SPL' (Saudi Post) asking for a 10 SAR customs fee via a link. What is this?","opts":[{"text":"A late fee for an old package","c":false,"ex":"It's a scam to steal your card info."},{"text":"A mistake by the post office","c":false,"ex":"No, it's deliberately sent by scammers."},{"text":"A normal procedure for international packages","c":false,"ex":"SPL never asks for payments via random SMS links."},{"text":"A common delivery phishing scam (Smishing)","c":true,"ex":"Correct! They want your credit card details, not 10 SAR."}]},{"t":"An SMS claiming to be from ZATCA has a link to pay an 'overdue invoice'. Should you click it?","opts":[{"text":"Only if the link ends in .com","c":false,"ex":"Government domains end in .gov.sa, not .com!"},{"text":"No, log in to the official ZATCA portal to check","c":true,"ex":"Correct! Always bypass the link and go to the source."},{"text":"Forward it to your accountant first","c":false,"ex":"Don't forward malicious links."},{"text":"Yes, tax invoices are urgent","c":false,"ex":"ZATCA uses official portals, not random SMS links."}]},{"t":"Why do scammers frequently use shortened links (like bit.ly) in SMS messages?","opts":[{"text":"To hide the real, suspicious website URL from you","c":true,"ex":"Correct! You can't see the real domain in a short link."},{"text":"To make the message look more professional","c":false,"ex":"It actually makes it look far less professional."},{"text":"Because telecom companies require short links","c":false,"ex":"Telecoms have no such requirement."},{"text":"To make the website load faster on mobile","c":false,"ex":"Short links actually redirect and add load time."}]},{"t":"You receive an SMS saying 'Your Aramex shipment is on hold' but you didn't order anything.","opts":[{"text":"Reply asking for the sender's details","c":false,"ex":"Replying confirms your phone number is active."},{"text":"Pay the fee, it might be a surprise gift","c":false,"ex":"Scammers rely on your curiosity. It's a trap!"},{"text":"Click the link just to see who sent it","c":false,"ex":"Clicking can expose your device to malware."},{"text":"Ignore it completely, it's a scam","c":true,"ex":"Correct! Spray-and-pray scams hit thousands at once."}]},{"t":"You get a random SMS with an OTP code for a banking app you haven't opened. What's happening?","opts":[{"text":"Your phone has a virus sending random texts","c":false,"ex":"The text is from the bank, but triggered by a hacker."},{"text":"Someone has your password and is trying to log in","c":true,"ex":"Correct! The OTP is the only thing stopping them. Change your password!"},{"text":"It's a delayed message from a previous login","c":false,"ex":"OTPs expire quickly and don't get delayed for long."},{"text":"The bank is doing a routine system test","c":false,"ex":"Banks do not send test OTPs."}]},{"t":"How can you safely verify if a delivery SMS is real without clicking the link?","opts":[{"text":"Open the official delivery app and track the shipment number","c":true,"ex":"Correct! The official app is secure and accurate."},{"text":"Wait to see if they send a second warning","c":false,"ex":"Scammers often send fake second warnings too."},{"text":"Call the number that sent the SMS","c":false,"ex":"The number belongs to the scammer."},{"text":"Check if the sender name looks official","c":false,"ex":"Sender names (like 'SMSA' or 'SPL') can be easily spoofed."}]}];
